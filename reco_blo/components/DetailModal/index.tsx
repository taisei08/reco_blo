          ...
          <Dialog.Portal>
            ...
            <Dialog.Content>
              <animated.div
                ...
                className="data-[state=open]:animate-contentShow fixed left-[50%] top-[50%] z-20 w-[800px] translate-x-[-50%] translate-y-[-50%] rounded-2xl bg-white px-6 py-6 shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px]"
              >
                ...
                <Dialog.Description className="mt-8">
                  <div>
                    {data.map((item) => (
                      <p key={item} className="text-black">
                        {item}
                      </p>
                    ))}
                  </div>
                ...
                <Dialog.Close asChild>
                  <div className="flex justify-center">
                    <button
                      onClick={() => setIsOpen(false)}
                      className="px-3 py-2 border bg-gray-300 text-white rounded-full"
                    >
                      承諾します
                    </button>
                  </div>
